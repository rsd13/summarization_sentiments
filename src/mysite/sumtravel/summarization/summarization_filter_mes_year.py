...
import pandas as pd
from .graficas import freq_word, get_plot_filter_mes_year
...
def get_sum_filter_mes_year(id,nlp, año, mes):

    datos = queery(conn(), id, año, mes)
    #lo ordeno por mes
    ...
    dic["grafica_positiva"] = get_plot_filter_mes_year(frases_positivas)
    dic["grafica_negativa"] = get_plot_filter_mes_year(frases_negativas)
    dic["grafica_neutra"] = get_plot_filter_mes_year(frases_neutras)
